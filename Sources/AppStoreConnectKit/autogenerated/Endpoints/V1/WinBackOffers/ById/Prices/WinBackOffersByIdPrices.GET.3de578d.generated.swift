...
extension V1.WinBackOffers.ById.Prices {
    public struct GET: Endpoint {
        public typealias Response = WinBackOfferPricesResponse
        ...
        /// - Returns: **200**, List of WinBackOfferPrices as `WinBackOfferPricesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(WinBackOfferPricesResponse.self, from: data)
...
extension V1.WinBackOffers.ById.Prices.GET {
