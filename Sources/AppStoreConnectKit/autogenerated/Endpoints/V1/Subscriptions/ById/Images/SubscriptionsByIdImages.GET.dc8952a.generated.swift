...
extension V1.Subscriptions.ById.Images {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionImagesResponse
        ...
        /// - Returns: **200**, List of SubscriptionImages as `SubscriptionImagesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionImagesResponse.self, from: data)
...
extension V1.Subscriptions.ById.Images.GET {
