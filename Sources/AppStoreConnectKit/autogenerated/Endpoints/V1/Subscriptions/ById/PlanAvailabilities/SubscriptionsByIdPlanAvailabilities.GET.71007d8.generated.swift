...
extension V1.Subscriptions.ById.PlanAvailabilities {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionPlanAvailabilitiesResponse
        ...
        /// - Returns: **200**, List of SubscriptionPlanAvailabilities as `SubscriptionPlanAvailabilitiesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionPlanAvailabilitiesResponse.self, from: data)
...
extension V1.Subscriptions.ById.PlanAvailabilities.GET {
