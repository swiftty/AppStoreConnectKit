...
extension V1.GameCenterLeaderboardSetReleases {
    public struct POST: Endpoint {
        ...
        /// - Returns: **201**, Single GameCenterLeaderboardSetRelease as `GameCenterLeaderboardSetReleaseResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 201:
                return try jsonDecoder.decode(GameCenterLeaderboardSetReleaseResponse.self, from: data)
