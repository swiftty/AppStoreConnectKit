...
extension V1.GameCenterActivityVersions.ById {
    public struct GET: Endpoint {
        public typealias Response = GameCenterActivityVersionResponse

        public var path: String {
            "/v1/gameCenterActivityVersions/\(id)"
        }
        ...
        /// - Returns: **200**, Single GameCenterActivityVersion as `GameCenterActivityVersionResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterActivityVersionResponse.self, from: data)
...
extension V1.GameCenterActivityVersions.ById.GET {
