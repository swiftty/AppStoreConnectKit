...
extension V1.GameCenterActivityVersions.ById.DefaultImage {
    public struct GET: Endpoint {
        ...
        /// - Returns: **200**, Single GameCenterActivityImage as `GameCenterActivityImageResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterActivityImageResponse.self, from: data)
...
extension V1.GameCenterActivityVersions.ById.DefaultImage.GET {
