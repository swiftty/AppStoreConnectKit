...
extension V1.InAppPurchasePriceSchedules.ById.BaseTerritory {
    public struct GET: Endpoint {
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(TerritoryResponse.self, from: data)
...
extension V1.InAppPurchasePriceSchedules.ById.BaseTerritory.GET {
...
extension Relation<V1.InAppPurchasePriceSchedules.ById.BaseTerritory.GET.Parameters.Fields, [V1.InAppPurchasePriceSchedules.ById.BaseTerritory.GET.Parameters.Fields.Territories]?> {
