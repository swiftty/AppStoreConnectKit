...
extension V1.AppStoreVersionLocalizations.ById.SearchKeywords {
    public struct GET: Endpoint {
        public typealias Response = AppKeywordsResponse

        public var path: String {
            "/v1/appStoreVersionLocalizations/\(id)/searchKeywords"
        }
...
extension V1.AppStoreVersionLocalizations.ById.SearchKeywords.GET {
