...
extension V1.GameCenterLeaderboardSetLocalizations.ById {
    public struct GET: Endpoint {
        ...
        /// - Returns: **200**, Single GameCenterLeaderboardSetLocalization as `GameCenterLeaderboardSetLocalizationResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterLeaderboardSetLocalizationResponse.self, from: data)
...
extension V1.GameCenterLeaderboardSetLocalizations.ById.GET {
