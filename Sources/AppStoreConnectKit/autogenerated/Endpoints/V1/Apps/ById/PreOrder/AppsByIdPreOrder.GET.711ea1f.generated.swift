...
extension V1.Apps.ById.PreOrder {
    @available(*, deprecated)
    public struct GET: Endpoint {
        public typealias Response = AppPreOrderWithoutIncludesResponse
        ...
        /// - Returns: **200**, Single AppPreOrder with get as `AppPreOrderWithoutIncludesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AppPreOrderWithoutIncludesResponse.self, from: data)
...
extension V1.Apps.ById.PreOrder.GET {
