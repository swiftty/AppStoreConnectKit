...
extension V1.Apps.ById.BackgroundAssets {
    public struct GET: Endpoint {
        public typealias Response = BackgroundAssetsResponse

        public var path: String {
            "/v1/apps/\(id)/backgroundAssets"
        }
        ...
        /// - Returns: **200**, List of BackgroundAssets as `BackgroundAssetsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(BackgroundAssetsResponse.self, from: data)
...
extension V1.Apps.ById.BackgroundAssets.GET {
