...
extension V1.Apps.ById.PromotedPurchases {
    public struct GET: Endpoint {
        public typealias Response = PromotedPurchasesResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(PromotedPurchasesResponse.self, from: data)
...
extension V1.Apps.ById.PromotedPurchases.GET {
