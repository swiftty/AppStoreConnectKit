...
extension V1.Apps.ById.BetaFeedbackCrashSubmissions {
    public struct GET: Endpoint {
        public typealias Response = BetaFeedbackCrashSubmissionsResponse
        ...
        /// - Returns: **200**, List of BetaFeedbackCrashSubmissions as `BetaFeedbackCrashSubmissionsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(BetaFeedbackCrashSubmissionsResponse.self, from: data)
...
extension V1.Apps.ById.BetaFeedbackCrashSubmissions.GET {
