    ...
    public struct GET: Endpoint {
        ...
        public func request(with baseURL: URL) throws -> URLRequest? {
            ...
            components?.queryItems = [
                ...
                URLQueryItem(name: "filter[appVersionState]",
                             value: parameters.filter[.appVersionState]?.map { "\($0)" }.joined(separator: ",")),
        ...
        /// - Returns: **200**, List of AppStoreVersions as `AppStoreVersionsResponse`
...
extension V1.Apps.ById.AppStoreVersions.GET {
    public struct Parameters: Hashable {
        ...
        public struct Fields: Hashable {
            ...
            public struct AppStoreVersionSubmissions: Hashable, Codable, RawRepresentable, CustomStringConvertible, Sendable {
                public static var appStoreVersion: Self {
                    .init(rawValue: "appStoreVersion")
                }
        ...
        public struct Filter: Hashable {
            ...
            public struct AppStoreState: Hashable, Codable, RawRepresentable, CustomStringConvertible, Sendable {
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var appVersionState: Relation<[AppVersionState]?> {
                    .init(key: "filter[appVersionState]")
                }
