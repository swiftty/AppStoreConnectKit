...
extension V1.Apps.ById.Webhooks {
    public struct GET: Endpoint {
        public typealias Response = WebhooksResponse
        ...
        public func request(with baseURL: URL) throws -> URLRequest? {
            ...
            components?.queryItems = [
                ...
                URLQueryItem(name: "fields[webhooks]",
                             value: parameters.fields[.webhooks]?.map { "\($0)" }.joined(separator: ",")),
        ...
        /// - Returns: **200**, List of Webhooks as `WebhooksResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(WebhooksResponse.self, from: data)
...
extension V1.Apps.ById.Webhooks.GET {
    public struct Parameters: Hashable {
        ...
        public struct Fields: Hashable {
            ...
            public struct Webhooks: Hashable, Codable, RawRepresentable, CustomStringConvertible, Sendable {
                public static var app: Self {
                    .init(rawValue: "app")
                }

                public static var deliveries: Self {
                    .init(rawValue: "deliveries")
                }
                ...
                public static var eventTypes: Self {
                    .init(rawValue: "eventTypes")
                }
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var webhooks: Relation<[Webhooks]?> {
                    .init(key: "fields[webhooks]")
                }
