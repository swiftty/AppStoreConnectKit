...
extension V1.Apps.ById.AndroidToIosAppMappingDetails {
    public struct GET: Endpoint {
        public typealias Response = AndroidToIosAppMappingDetailsResponse

        public var path: String {
            "/v1/apps/\(id)/androidToIosAppMappingDetails"
        }
        ...
        /// - Returns: **200**, List of AndroidToIosAppMappingDetails as `AndroidToIosAppMappingDetailsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AndroidToIosAppMappingDetailsResponse.self, from: data)
...
extension V1.Apps.ById.AndroidToIosAppMappingDetails.GET {
