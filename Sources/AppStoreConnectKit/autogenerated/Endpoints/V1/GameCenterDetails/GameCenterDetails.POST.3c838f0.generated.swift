...
extension V1.GameCenterDetails {
    public struct POST: Endpoint {
        public typealias Parameters = GameCenterDetailCreateRequest
        ...
        /// - Returns: **201**, Single GameCenterDetail as `GameCenterDetailResponse`
