...
extension V1.GameCenterDetails.ById.GameCenterActivities {
    public struct GET: Endpoint {
        public typealias Response = GameCenterActivitiesResponse

        public var path: String {
            "/v1/gameCenterDetails/\(id)/gameCenterActivities"
        }
...
extension V1.GameCenterDetails.ById.GameCenterActivities.GET {
