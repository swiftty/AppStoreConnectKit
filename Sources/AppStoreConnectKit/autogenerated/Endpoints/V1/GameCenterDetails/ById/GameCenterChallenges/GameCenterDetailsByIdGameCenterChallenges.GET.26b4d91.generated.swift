...
extension V1.GameCenterDetails.ById.GameCenterChallenges {
    public struct GET: Endpoint {
        public typealias Response = GameCenterChallengesResponse

        public var path: String {
            "/v1/gameCenterDetails/\(id)/gameCenterChallenges"
        }
...
extension V1.GameCenterDetails.ById.GameCenterChallenges.GET {
