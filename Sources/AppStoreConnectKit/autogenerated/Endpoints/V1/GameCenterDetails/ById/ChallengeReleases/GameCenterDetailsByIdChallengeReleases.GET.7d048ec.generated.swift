...
extension V1.GameCenterDetails.ById.ChallengeReleases {
    public struct GET: Endpoint {
        public typealias Response = GameCenterChallengeVersionReleasesResponse

        public var path: String {
            "/v1/gameCenterDetails/\(id)/challengeReleases"
        }
        ...
        /// - Returns: **200**, List of GameCenterChallengeVersionReleases as `GameCenterChallengeVersionReleasesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterChallengeVersionReleasesResponse.self, from: data)
...
extension V1.GameCenterDetails.ById.ChallengeReleases.GET {
