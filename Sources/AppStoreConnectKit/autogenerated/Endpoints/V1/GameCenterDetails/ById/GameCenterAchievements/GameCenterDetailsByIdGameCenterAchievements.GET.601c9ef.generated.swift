...
extension V1.GameCenterDetails.ById.GameCenterAchievements {
    public struct GET: Endpoint {
        public typealias Response = GameCenterAchievementsResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterAchievementsResponse.self, from: data)
...
extension V1.GameCenterDetails.ById.GameCenterAchievements.GET {
