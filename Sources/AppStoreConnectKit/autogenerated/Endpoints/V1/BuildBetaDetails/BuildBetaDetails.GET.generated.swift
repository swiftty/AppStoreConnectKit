...
extension V1.BuildBetaDetails {
    public struct GET: Endpoint {
        public typealias Response = BuildBetaDetailsResponse
        ...
        /// - Returns: **200**, List of BuildBetaDetails as `BuildBetaDetailsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(BuildBetaDetailsResponse.self, from: data)
...
extension V1.BuildBetaDetails.GET {
