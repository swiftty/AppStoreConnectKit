...
extension V1.SubscriptionPricePoints.ById.AdjustedEqualizations {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionPricePointsResponse

        public var path: String {
            "/v1/subscriptionPricePoints/\(id)/adjustedEqualizations"
        }
...
extension V1.SubscriptionPricePoints.ById.AdjustedEqualizations.GET {
