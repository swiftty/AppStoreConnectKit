...
extension V1.PromotedPurchases.ById {
...
extension V1.PromotedPurchases.ById.GET {
...
extension Relation<V1.PromotedPurchases.ById.GET.Parameters.Fields, [V1.PromotedPurchases.ById.GET.Parameters.Fields.PromotedPurchaseImages]?> {
...
extension Relation<V1.PromotedPurchases.ById.GET.Parameters.Fields, [V1.PromotedPurchases.ById.GET.Parameters.Fields.PromotedPurchases]?> {
...
extension Relation<V1.PromotedPurchases.ById.GET.Parameters.Limit, Int?> {
