...
extension V1.PromotedPurchases {
    public struct POST: Endpoint {
        public typealias Parameters = PromotedPurchaseCreateRequest
        ...
        /// - Returns: **201**, Single PromotedPurchase as `PromotedPurchaseResponse`
