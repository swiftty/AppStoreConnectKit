...
extension V1.CiBuildActions.ById.TestResults {
    public struct GET: Endpoint {
        public typealias Response = CiTestResultsResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(CiTestResultsResponse.self, from: data)
...
extension V1.CiBuildActions.ById.TestResults.GET {
...
extension Relation<V1.CiBuildActions.ById.TestResults.GET.Parameters.Fields, [V1.CiBuildActions.ById.TestResults.GET.Parameters.Fields.CiTestResults]?> {
