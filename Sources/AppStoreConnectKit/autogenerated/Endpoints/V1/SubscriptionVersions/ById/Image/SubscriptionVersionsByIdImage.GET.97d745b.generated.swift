...
extension V1.SubscriptionVersions.ById.Image {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionImageV2Response

        public var path: String {
            "/v1/subscriptionVersions/\(id)/image"
        }
        ...
        /// - Returns: **200**, Single SubscriptionImage as `SubscriptionImageV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionImageV2Response.self, from: data)
...
extension V1.SubscriptionVersions.ById.Image.GET {
