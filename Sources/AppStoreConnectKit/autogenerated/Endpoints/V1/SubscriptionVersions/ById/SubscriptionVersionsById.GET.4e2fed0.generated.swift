...
extension V1.SubscriptionVersions.ById {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionVersionResponse

        public var path: String {
            "/v1/subscriptionVersions/\(id)"
        }
        ...
        /// - Returns: **200**, Single SubscriptionVersion as `SubscriptionVersionResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionVersionResponse.self, from: data)
...
extension V1.SubscriptionVersions.ById.GET {
