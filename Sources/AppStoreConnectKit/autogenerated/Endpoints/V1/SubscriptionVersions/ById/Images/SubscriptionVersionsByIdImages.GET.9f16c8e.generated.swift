...
extension V1.SubscriptionVersions.ById.Images {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionImagesV2Response

        public var path: String {
            "/v1/subscriptionVersions/\(id)/images"
        }
        ...
        /// - Returns: **200**, List of SubscriptionImages as `SubscriptionImagesV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionImagesV2Response.self, from: data)
...
extension V1.SubscriptionVersions.ById.Images.GET {
