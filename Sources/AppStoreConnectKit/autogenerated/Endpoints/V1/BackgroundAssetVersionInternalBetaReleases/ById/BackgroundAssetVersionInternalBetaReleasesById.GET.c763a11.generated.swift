...
extension V1.BackgroundAssetVersionInternalBetaReleases.ById {
    public struct GET: Endpoint {
        public typealias Response = BackgroundAssetVersionInternalBetaReleaseResponse
        ...
        /// - Returns: **200**, Single BackgroundAssetVersionInternalBetaRelease as `BackgroundAssetVersionInternalBetaReleaseResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(BackgroundAssetVersionInternalBetaReleaseResponse.self, from: data)
...
extension V1.BackgroundAssetVersionInternalBetaReleases.ById.GET {
