...
extension Relation<V1.CiMacOsVersions.ById.GET.Parameters.Fields, [V1.CiMacOsVersions.ById.GET.Parameters.Fields.CiMacOsVersions]?> {
...
extension Relation<V1.CiMacOsVersions.ById.GET.Parameters.Fields, [V1.CiMacOsVersions.ById.GET.Parameters.Fields.CiXcodeVersions]?> {
...
extension Relation<V1.CiMacOsVersions.ById.GET.Parameters.Limit, Int?> {
