...
extension V1.GameCenterChallengeVersions.ById {
    public struct GET: Endpoint {
        public typealias Response = GameCenterChallengeVersionResponse

        public var path: String {
            "/v1/gameCenterChallengeVersions/\(id)"
        }
        ...
        /// - Returns: **200**, Single GameCenterChallengeVersion as `GameCenterChallengeVersionResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterChallengeVersionResponse.self, from: data)
...
extension V1.GameCenterChallengeVersions.ById.GET {
