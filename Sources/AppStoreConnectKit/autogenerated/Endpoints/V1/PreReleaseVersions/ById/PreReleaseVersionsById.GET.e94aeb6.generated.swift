...
extension Relation<V1.PreReleaseVersions.ById.GET.Parameters.Fields, [V1.PreReleaseVersions.ById.GET.Parameters.Fields.Apps]?> {
...
extension Relation<V1.PreReleaseVersions.ById.GET.Parameters.Fields, [V1.PreReleaseVersions.ById.GET.Parameters.Fields.Builds]?> {
...
extension Relation<V1.PreReleaseVersions.ById.GET.Parameters.Fields, [V1.PreReleaseVersions.ById.GET.Parameters.Fields.PreReleaseVersions]?> {
...
extension Relation<V1.PreReleaseVersions.ById.GET.Parameters.Limit, Int?> {
