...
extension V1.GameCenterAppVersions {
    public struct POST: Endpoint {
        public typealias Parameters = GameCenterAppVersionCreateRequest
        ...
        /// - Returns: **201**, Single GameCenterAppVersion as `GameCenterAppVersionResponse`
