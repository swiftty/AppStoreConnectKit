...
extension V1.GameCenterMatchmakingRules.ById.Metrics.MatchmakingBooleanRuleResults {
    public struct GET: Endpoint {
        public typealias Response = GameCenterMatchmakingBooleanRuleResultsV1MetricResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterMatchmakingBooleanRuleResultsV1MetricResponse.self, from: data)
...
extension V1.GameCenterMatchmakingRules.ById.Metrics.MatchmakingBooleanRuleResults.GET {
    public struct Parameters: Hashable {
        ...
        public struct Filter: Hashable {
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var result: Relation<String?> {
