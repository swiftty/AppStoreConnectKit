...
extension Relation<V1.AppPricePoints.GET.Parameters.Fields, [V1.AppPricePoints.GET.Parameters.Fields.AppPricePoints]?> {
...
extension Relation<V1.AppPricePoints.GET.Parameters.Fields, [V1.AppPricePoints.GET.Parameters.Fields.Territories]?> {
...
extension Relation<V1.AppPricePoints.GET.Parameters.Filter, [String]?> {
