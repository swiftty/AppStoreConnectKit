...
extension V1.GameCenterActivities.ById {
    public struct GET: Endpoint {
        public typealias Response = GameCenterActivityResponse

        public var path: String {
            "/v1/gameCenterActivities/\(id)"
        }
        ...
        /// - Returns: **200**, Single GameCenterActivity as `GameCenterActivityResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterActivityResponse.self, from: data)
...
extension V1.GameCenterActivities.ById.GET {
