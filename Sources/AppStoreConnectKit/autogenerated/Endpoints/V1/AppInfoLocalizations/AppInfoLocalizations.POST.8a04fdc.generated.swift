...
extension V1.AppInfoLocalizations {
    public struct POST: Endpoint {
        public typealias Parameters = AppInfoLocalizationCreateRequest
        ...
        /// - Returns: **201**, Single AppInfoLocalization as `AppInfoLocalizationResponse`
