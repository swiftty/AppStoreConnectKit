...
extension V1.BetaTesters.GET {
    public struct Parameters: Hashable {
        ...
        public struct Filter: Hashable {
            ...
            public enum InviteType: Hashable, Codable, RawRepresentable {
                case email
                case publicLink
                case unknown(String)
        ...
        public enum Sort: Hashable, Codable, RawRepresentable {
            ...
            public var rawValue: String {
                ...
                case .firstName: return "firstName"
                case .firstNameDesc: return "-firstName"
                case .inviteType: return "inviteType"
                case .inviteTypeDesc: return "-inviteType"
                case .lastName: return "lastName"
            ...
            public init(rawValue: String) {
                ...
                case "firstName": self = .firstName
                case "-firstName": self = .firstNameDesc
                case "inviteType": self = .inviteType
                case "-inviteType": self = .inviteTypeDesc
                case "lastName": self = .lastName
