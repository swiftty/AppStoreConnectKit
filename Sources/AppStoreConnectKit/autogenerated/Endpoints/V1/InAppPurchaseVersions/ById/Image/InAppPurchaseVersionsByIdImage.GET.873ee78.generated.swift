...
extension V1.InAppPurchaseVersions.ById.Image {
    public struct GET: Endpoint {
        public typealias Response = InAppPurchaseImageV2Response

        public var path: String {
            "/v1/inAppPurchaseVersions/\(id)/image"
        }
        ...
        /// - Returns: **200**, Single InAppPurchaseImage as `InAppPurchaseImageV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(InAppPurchaseImageV2Response.self, from: data)
...
extension V1.InAppPurchaseVersions.ById.Image.GET {
