...
extension V1.InAppPurchaseVersions.ById {
    public struct GET: Endpoint {
        public typealias Response = InAppPurchaseVersionResponse

        public var path: String {
            "/v1/inAppPurchaseVersions/\(id)"
        }
        ...
        /// - Returns: **200**, Single InAppPurchaseVersion as `InAppPurchaseVersionResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(InAppPurchaseVersionResponse.self, from: data)
...
extension V1.InAppPurchaseVersions.ById.GET {
