...
extension V1.GameCenterGroups.ById.GameCenterDetails {
    public struct GET: Endpoint {
        public typealias Response = GameCenterDetailsResponse
        ...
        public func request(with baseURL: URL) throws -> URLRequest? {
            ...
            components?.queryItems = [
                ...
                URLQueryItem(name: "filter[gameCenterAppVersions.enabled]",
                             value: parameters.filter[.gameCenterAppVersionsEnabled]?.map { "\($0)" }.joined(separator: ",")),
        ...
        /// - Returns: **200**, List of GameCenterDetails as `GameCenterDetailsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterDetailsResponse.self, from: data)
...
extension V1.GameCenterGroups.ById.GameCenterDetails.GET {
    public struct Parameters: Hashable {
        ...
        public struct Filter: Hashable {
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var gameCenterAppVersionsEnabled: Relation<[String]?> {
                    .init(key: "filter[gameCenterAppVersions.enabled]")
                }
