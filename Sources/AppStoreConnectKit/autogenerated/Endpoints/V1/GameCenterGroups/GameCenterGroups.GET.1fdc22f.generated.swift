...
extension V1.GameCenterGroups {
    public struct GET: Endpoint {
        public typealias Response = GameCenterGroupsResponse
        ...
        public func request(with baseURL: URL) throws -> URLRequest? {
            ...
            components?.queryItems = [
                ...
                URLQueryItem(name: "filter[gameCenterDetails]",
        ...
        /// - Returns: **200**, List of GameCenterGroups as `GameCenterGroupsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterGroupsResponse.self, from: data)
...
extension V1.GameCenterGroups.GET {
    public struct Parameters: Hashable {
        ...
        public struct Filter: Hashable {
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var gameCenterDetails: Relation<[String]?> {
                    .init(key: "filter[gameCenterDetails]")
                }
