...
extension V1.GameCenterChallenges.ById.Versions {
    public struct GET: Endpoint {
        public typealias Response = GameCenterChallengeVersionsResponse

        public var path: String {
            "/v1/gameCenterChallenges/\(id)/versions"
        }
        ...
        /// - Returns: **200**, List of GameCenterChallengeVersions as `GameCenterChallengeVersionsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterChallengeVersionsResponse.self, from: data)
...
extension V1.GameCenterChallenges.ById.Versions.GET {
