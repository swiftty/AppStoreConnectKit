...
extension V1.BackgroundAssetVersionAppStoreReleases.ById {
    public struct GET: Endpoint {
        public typealias Response = BackgroundAssetVersionAppStoreReleaseResponse
        ...
        /// - Returns: **200**, Single BackgroundAssetVersionAppStoreRelease as `BackgroundAssetVersionAppStoreReleaseResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(BackgroundAssetVersionAppStoreReleaseResponse.self, from: data)
...
extension V1.BackgroundAssetVersionAppStoreReleases.ById.GET {
