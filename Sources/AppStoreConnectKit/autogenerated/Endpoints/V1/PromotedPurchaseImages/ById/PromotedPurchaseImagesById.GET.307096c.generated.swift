...
extension V1.PromotedPurchaseImages.ById {
    public struct GET: Endpoint {
        public typealias Response = PromotedPurchaseImageResponse
        ...
        /// - Returns: **200**, Single PromotedPurchaseImage as `PromotedPurchaseImageResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(PromotedPurchaseImageResponse.self, from: data)
...
extension V1.PromotedPurchaseImages.ById.GET {
...
extension Relation<V1.PromotedPurchaseImages.ById.GET.Parameters.Fields, [V1.PromotedPurchaseImages.ById.GET.Parameters.Fields.PromotedPurchaseImages]?> {
