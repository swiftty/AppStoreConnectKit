...
extension V1.AppEventLocalizations.ById {
    public struct GET: Endpoint {
        public typealias Response = AppEventLocalizationResponse
        ...
        /// - Returns: **200**, Single AppEventLocalization as `AppEventLocalizationResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AppEventLocalizationResponse.self, from: data)
...
extension V1.AppEventLocalizations.ById.GET {
