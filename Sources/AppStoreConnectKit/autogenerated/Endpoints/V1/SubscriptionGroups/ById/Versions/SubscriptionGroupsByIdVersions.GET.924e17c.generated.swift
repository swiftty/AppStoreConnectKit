...
extension V1.SubscriptionGroups.ById.Versions {
    public struct GET: Endpoint {
        public typealias Response = SubscriptionGroupVersionsResponse

        public var path: String {
            "/v1/subscriptionGroups/\(id)/versions"
        }
        ...
        /// - Returns: **200**, List of SubscriptionGroupVersions as `SubscriptionGroupVersionsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionGroupVersionsResponse.self, from: data)
...
extension V1.SubscriptionGroups.ById.Versions.GET {
