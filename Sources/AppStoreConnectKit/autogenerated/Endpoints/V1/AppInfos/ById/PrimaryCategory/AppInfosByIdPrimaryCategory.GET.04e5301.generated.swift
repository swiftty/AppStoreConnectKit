...
extension V1.AppInfos.ById.PrimaryCategory {
...
extension V1.AppInfos.ById.PrimaryCategory.GET {
...
extension Relation<V1.AppInfos.ById.PrimaryCategory.GET.Parameters.Fields, [V1.AppInfos.ById.PrimaryCategory.GET.Parameters.Fields.AppCategories]?> {
...
extension Relation<V1.AppInfos.ById.PrimaryCategory.GET.Parameters.Limit, Int?> {
