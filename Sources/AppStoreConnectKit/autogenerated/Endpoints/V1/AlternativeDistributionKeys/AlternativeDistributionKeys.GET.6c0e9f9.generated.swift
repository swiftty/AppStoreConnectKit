...
extension V1.AlternativeDistributionKeys {
    public struct GET: Endpoint {
        public typealias Response = AlternativeDistributionKeysResponse
        ...
        public func request(with baseURL: URL) throws -> URLRequest? {
            ...
            components?.queryItems = [
                URLQueryItem(name: "exists[app]",
                             value: parameters.exists[.app].map { "\($0)" }),
        ...
        /// - Returns: **200**, List of AlternativeDistributionKeys as `AlternativeDistributionKeysResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AlternativeDistributionKeysResponse.self, from: data)
...
extension V1.AlternativeDistributionKeys.GET {
    public struct Parameters: Hashable {
        ...
        public struct Exists: Hashable {
            ...
            public struct Relation<T>: Hashable {
                ...
                public static var app: Relation<Bool?> {
                    .init(key: "exists[app]")
                }
