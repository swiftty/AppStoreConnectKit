...
extension Relation<V1.ScmProviders.ById.Repositories.GET.Parameters.Fields, [V1.ScmProviders.ById.Repositories.GET.Parameters.Fields.ScmGitReferences]?> {
...
extension Relation<V1.ScmProviders.ById.Repositories.GET.Parameters.Fields, [V1.ScmProviders.ById.Repositories.GET.Parameters.Fields.ScmProviders]?> {
...
extension Relation<V1.ScmProviders.ById.Repositories.GET.Parameters.Fields, [V1.ScmProviders.ById.Repositories.GET.Parameters.Fields.ScmRepositories]?> {
...
extension Relation<V1.ScmProviders.ById.Repositories.GET.Parameters.Filter, [String]?> {
    /// filter by id(s)
