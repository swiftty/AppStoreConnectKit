...
extension Relation<V1.CiXcodeVersions.ById.GET.Parameters.Fields, [V1.CiXcodeVersions.ById.GET.Parameters.Fields.CiMacOsVersions]?> {
...
extension Relation<V1.CiXcodeVersions.ById.GET.Parameters.Fields, [V1.CiXcodeVersions.ById.GET.Parameters.Fields.CiXcodeVersions]?> {
...
extension Relation<V1.CiXcodeVersions.ById.GET.Parameters.Limit, Int?> {
