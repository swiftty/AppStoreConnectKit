...
extension V1.MerchantIds.ById {
    public struct PATCH: Endpoint {
        public typealias Parameters = MerchantIdUpdateRequest
        ...
        /// - Returns: **200**, Single MerchantId as `MerchantIdResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(MerchantIdResponse.self, from: data)
