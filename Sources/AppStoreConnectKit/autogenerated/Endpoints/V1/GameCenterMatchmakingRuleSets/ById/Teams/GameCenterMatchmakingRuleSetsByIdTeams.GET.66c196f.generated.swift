...
extension V1.GameCenterMatchmakingRuleSets.ById.Teams {
    public struct GET: Endpoint {
        public typealias Response = GameCenterMatchmakingTeamsResponse
        ...
        /// - Returns: **200**, List of GameCenterMatchmakingTeams as `GameCenterMatchmakingTeamsResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterMatchmakingTeamsResponse.self, from: data)
...
extension V1.GameCenterMatchmakingRuleSets.ById.Teams.GET {
