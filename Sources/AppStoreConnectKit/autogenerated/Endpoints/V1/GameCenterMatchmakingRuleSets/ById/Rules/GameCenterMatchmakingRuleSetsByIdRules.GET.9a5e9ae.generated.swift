...
extension V1.GameCenterMatchmakingRuleSets.ById.Rules {
    public struct GET: Endpoint {
        public typealias Response = GameCenterMatchmakingRulesResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterMatchmakingRulesResponse.self, from: data)
...
extension V1.GameCenterMatchmakingRuleSets.ById.Rules.GET {
