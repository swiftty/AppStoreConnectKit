...
extension V1.AppCustomProductPageLocalizations.ById.SearchKeywords {
    public struct GET: Endpoint {
        public typealias Response = AppKeywordsResponse

        public var path: String {
            "/v1/appCustomProductPageLocalizations/\(id)/searchKeywords"
        }
...
extension V1.AppCustomProductPageLocalizations.ById.SearchKeywords.GET {
