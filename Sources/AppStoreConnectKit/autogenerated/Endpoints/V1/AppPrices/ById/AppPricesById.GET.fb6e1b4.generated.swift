...
extension V1.AppPrices.ById {
    ...
    public struct GET: Endpoint {
        ...
        /// - Returns: **200**, Single AppPrice as `AppPriceResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AppPriceResponse.self, from: data)
...
extension V1.AppPrices.ById.GET {
...
extension Relation<V1.AppPrices.ById.GET.Parameters.Fields, [V1.AppPrices.ById.GET.Parameters.Fields.AppPrices]?> {
