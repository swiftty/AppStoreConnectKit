...
extension V1.GameCenterChallengeImages.ById {
    public struct GET: Endpoint {
        public typealias Response = GameCenterChallengeImageResponse

        public var path: String {
            "/v1/gameCenterChallengeImages/\(id)"
        }
        ...
        /// - Returns: **200**, Single GameCenterChallengeImage as `GameCenterChallengeImageResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterChallengeImageResponse.self, from: data)
...
extension V1.GameCenterChallengeImages.ById.GET {
