...
extension V1.AlternativeDistributionPackageDeltas.ById {
    public struct GET: Endpoint {
        public typealias Response = AlternativeDistributionPackageDeltaResponse
        ...
        /// - Returns: **200**, Single AlternativeDistributionPackageDelta as `AlternativeDistributionPackageDeltaResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AlternativeDistributionPackageDeltaResponse.self, from: data)
...
extension V1.AlternativeDistributionPackageDeltas.ById.GET {
