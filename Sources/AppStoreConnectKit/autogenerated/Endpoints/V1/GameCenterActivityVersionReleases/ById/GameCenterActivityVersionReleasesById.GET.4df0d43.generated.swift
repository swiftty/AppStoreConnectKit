...
extension V1.GameCenterActivityVersionReleases.ById {
    public struct GET: Endpoint {
        ...
        public var path: String {
            "/v1/gameCenterActivityVersionReleases/\(id)"
        }
        ...
        /// - Returns: **200**, Single GameCenterActivityVersionRelease as `GameCenterActivityVersionReleaseResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterActivityVersionReleaseResponse.self, from: data)
...
extension V1.GameCenterActivityVersionReleases.ById.GET {
