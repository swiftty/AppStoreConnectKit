...
extension V1.AppScreenshots.ById {
    public struct GET: Endpoint {
        ...
        /// - Returns: **200**, Single AppScreenshot as `AppScreenshotResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AppScreenshotResponse.self, from: data)
...
extension V1.AppScreenshots.ById.GET {
...
extension Relation<V1.AppScreenshots.ById.GET.Parameters.Fields, [V1.AppScreenshots.ById.GET.Parameters.Fields.AppScreenshots]?> {
