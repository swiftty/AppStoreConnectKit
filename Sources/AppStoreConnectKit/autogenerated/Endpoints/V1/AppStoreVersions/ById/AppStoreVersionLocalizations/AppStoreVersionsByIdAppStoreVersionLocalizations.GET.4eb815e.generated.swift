...
extension V1.AppStoreVersions.ById.AppStoreVersionLocalizations {
    public struct GET: Endpoint {
        public typealias Response = AppStoreVersionLocalizationsWithoutIncludesResponse
        ...
        /// - Returns: **200**, List of AppStoreVersionLocalizations with get as `AppStoreVersionLocalizationsWithoutIncludesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AppStoreVersionLocalizationsWithoutIncludesResponse.self, from: data)
