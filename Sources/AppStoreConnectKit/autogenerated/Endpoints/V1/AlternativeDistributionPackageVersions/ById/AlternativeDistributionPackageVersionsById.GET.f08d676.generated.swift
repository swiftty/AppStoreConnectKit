...
extension V1.AlternativeDistributionPackageVersions.ById {
    public struct GET: Endpoint {
        public typealias Response = AlternativeDistributionPackageVersionResponse
        ...
        /// - Returns: **200**, Single AlternativeDistributionPackageVersion as `AlternativeDistributionPackageVersionResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(AlternativeDistributionPackageVersionResponse.self, from: data)
...
extension V1.AlternativeDistributionPackageVersions.ById.GET {
