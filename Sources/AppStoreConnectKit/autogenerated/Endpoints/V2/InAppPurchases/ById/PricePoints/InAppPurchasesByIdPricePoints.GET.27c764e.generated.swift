...
extension V2.InAppPurchases.ById.PricePoints {
    public struct GET: Endpoint {
        public typealias Response = InAppPurchasePricePointsResponse
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(InAppPurchasePricePointsResponse.self, from: data)
...
extension V2.InAppPurchases.ById.PricePoints.GET {
...
extension Relation<V2.InAppPurchases.ById.PricePoints.GET.Parameters.Fields, [V2.InAppPurchases.ById.PricePoints.GET.Parameters.Fields.InAppPurchasePricePoints]?> {
...
extension Relation<V2.InAppPurchases.ById.PricePoints.GET.Parameters.Fields, [V2.InAppPurchases.ById.PricePoints.GET.Parameters.Fields.Territories]?> {
...
extension Relation<V2.InAppPurchases.ById.PricePoints.GET.Parameters.Filter, [String]?> {
    /// filter by attribute 'priceTier'
    public static var priceTier: Relation {
