...
extension V2.InAppPurchases.ById.Images {
    public struct GET: Endpoint {
        public typealias Response = InAppPurchaseImagesResponse
        ...
        /// - Returns: **200**, List of InAppPurchaseImages as `InAppPurchaseImagesResponse`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(InAppPurchaseImagesResponse.self, from: data)
...
extension V2.InAppPurchases.ById.Images.GET {
