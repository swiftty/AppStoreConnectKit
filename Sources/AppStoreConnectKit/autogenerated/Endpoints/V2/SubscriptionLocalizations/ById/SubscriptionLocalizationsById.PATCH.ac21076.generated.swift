...
extension V2.SubscriptionLocalizations.ById {
    public struct PATCH: Endpoint {
        public typealias Parameters = SubscriptionLocalizationV2UpdateRequest
        ...
        /// - Returns: **200**, Single SubscriptionLocalization as `SubscriptionLocalizationV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(SubscriptionLocalizationV2Response.self, from: data)
