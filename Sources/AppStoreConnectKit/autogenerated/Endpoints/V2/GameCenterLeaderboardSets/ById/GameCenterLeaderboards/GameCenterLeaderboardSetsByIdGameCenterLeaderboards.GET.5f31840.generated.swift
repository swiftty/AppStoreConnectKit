...
extension V2.GameCenterLeaderboardSets.ById.GameCenterLeaderboards {
    public struct GET: Endpoint {
        public typealias Response = GameCenterLeaderboardsV2Response
        ...
        /// - Returns: **200**, List of GameCenterLeaderboards as `GameCenterLeaderboardsV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterLeaderboardsV2Response.self, from: data)
...
extension V2.GameCenterLeaderboardSets.ById.GameCenterLeaderboards.GET {
