...
extension V2.GameCenterLeaderboardSetLocalizations.ById.Image {
    public struct GET: Endpoint {
        public typealias Response = GameCenterLeaderboardSetImageV2Response
        ...
        /// - Returns: **200**, Single GameCenterLeaderboardSetImage as `GameCenterLeaderboardSetImageV2Response`
        ...
        public static func response(from data: Data, urlResponse: HTTPURLResponse) throws -> Response {
            ...
            case 200:
                return try jsonDecoder.decode(GameCenterLeaderboardSetImageV2Response.self, from: data)
...
extension V2.GameCenterLeaderboardSetLocalizations.ById.Image.GET {
